...
// 9x9 kernal.
const float blurArr[5] = float[](0.00759732401586, 0.0359939776755, 0.109340049784, 0.212965337015, 0.265961520268);
...
void main()
{
    ...
    if(dir.x+dir.y == 0.0)
        outColor = texture(finalTexture, fragTextureCoord).xyz;
    else
    {
